							...
							<div className='flex flex-col gap-4 mt-14 px-4'>
								...
								<div className='flex gap-2 flex-wrap'>
									{user?.link && (
										<div className='flex gap-1 items-center '>
											<>
												...
												<a
													href='https://chihabmezrigui.netlify.app/'
													target='_blank'
													rel='noreferrer'
									...
									<div className='flex gap-2 items-center'>
										<IoCalendarOutline className='w-4 h-4 text-slate-500 text-yellow-500' />
										<span className='text-sm text-slate-500 text-yellow-500'>{memberSinceDate}</span>
									</div>
								</div>
								<div className='flex gap-2'>
									<div className='flex gap-1 items-center'>
										<span className='font-bold text-xs text-yellow-500'>{user?.following.length}</span>
										<span className='text-slate-500 text-xs '>Following</span>
									</div>
									<div className='flex gap-1 items-center'>
										<span className='font-bold text-xs text-yellow-500'>{user?.followers.length}</span>
